...
def plot_full(m, g, v_d, torque_sat, t_axis,
    ...
    fig.savefig('./plots/solo_bounding_ip_joint_torques.png')
    ...
    fig.savefig('./plots/solo_bounding_ip_force_profiles.png')
    # CoM coordinates
    ...
    fig.savefig('./plots/solo_bounding_ip_CoM_coordinates.png')
    ...
    gph[3, 1].set_xlabel('t (s)')
    gph[3, 1].set_ylabel('F (N)')
    fig.savefig('./plots/solo_bounding_ip_contact_forces_simulation.png')
    ...
    fig.savefig('./plots/solo_bounding_ip_feedbacks.png')
    # mechanical power
    fig, gph = plt.subplots(2, 2, constrained_layout=True, figsize=(12, 6))
    ...
    fig.savefig('./plots/solo_bounding_ip_mechanical_power.png')
    # toe trajectory
    ...
    gph[3, 4].grid()
    fig.savefig('./plots/solo_bounding_ip_toe_trajectory.png')
    ...
    fig.savefig('./plots/solo_bounding_ip_stance_time.png')
    return
...
def plot_cnt(m, g, t_st_front_array, t_st_back_array, cnt_x_front, cnt_x_back, cnt_z_front, cnt_z_back):
    ...
    gph[1, 1].set_xlabel('t (s)')
    gph[1, 1].set_ylabel('F (N)')
    fig.savefig('./plots/solo_bounding_ip_contact_forces_stance.png')
    return
...
def plot_afb(t_st_front_array, t_st_back_array, afb_front, afb_back):
    ...
    fig.savefig('./plots/solo_bounding_ip_activation_feedback_stance.png')
    return
