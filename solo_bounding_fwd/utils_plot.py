...
def plot_full(m, g, v_d, torque_sat, t_axis,
    ...
    fig.savefig('./plots/solo_bounding_fwd_joint_torques.png')
    ...
    fig.savefig('./plots/solo_bounding_fwd_force_profiles.png')
    # CoM coordinates
    ...
    fig.savefig('./plots/solo_bounding_fwd_CoM_coordinates.png')
    ...
    gph[3, 1].set_xlabel('t (s)')
    gph[3, 1].set_ylabel('F (N)')
    fig.savefig('./plots/solo_bounding_fwd_contact_forces_simulation.png')
    ...
    fig.savefig('./plots/solo_bounding_fwd_feedbacks.png')
    # mechanical power
    fig, gph = plt.subplots(2, 2, constrained_layout=True, figsize=(12, 6))
    ...
    fig.savefig('./plots/solo_bounding_fwd_mechanical_power.png')
    # toe trajectory
    ...
    gph[3, 4].grid()
    fig.savefig('./plots/solo_bounding_fwd_toe_trajectory.png')
    ...
    gph[1].grid()
    fig.savefig('./plots/solo_bounding_fwd_corrected_swing_trajectory.png')
    ...
    gph[2, 3].grid()
    fig.savefig('./plots/solo_bounding_fwd_desired_swing_trajectory_simulation.png')
    ...
    fig.savefig('./plots/solo_bounding_fwd_v_avg.png')
    ...
    fig.savefig('./plots/solo_bounding_fwd_stance_time.png')
    return
...
def plot_traj_sw(beta_sw_x, beta_sw_z, t_sw_array, x_traj_sw, z_traj_sw, vx_traj_sw, vz_traj_sw):
    ...
    gph[2, 1].set_ylabel('vz (m/s)')
    gph[2, 1].grid()
    fig.savefig('./plots/solo_bounding_fwd_desired_original_swing_trajectory.png')
    ...
    gph.set_ylabel('z (m)')
    gph.grid()
    fig.savefig('./plots/solo_bounding_fwd_desired_original_swing_trajectory_02.png')
    return
...
def plot_cnt(m, g, t_st_front_array, t_st_back_array, cnt_x_front, cnt_x_back, cnt_z_front, cnt_z_back):
    ...
    gph[1, 1].set_xlabel('t (s)')
    gph[1, 1].set_ylabel('F (N)')
    fig.savefig('./plots/solo_bounding_fwd_contact_forces_stance.png')
    return
...
def plot_afb(t_st_front_array, t_st_back_array, afb_front, afb_back):
    ...
    fig.savefig('./plots/solo_bounding_fwd_activation_feedback_stance.png')
    return
